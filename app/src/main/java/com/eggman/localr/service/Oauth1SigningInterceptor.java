...
/**
 * Will sign requests following the Oauth 1.0a requirements. This interceptor was provided as a gist
 * from Jake Wharton and modified to have the access token be passed in dynamically through a callback
 * (see TokenProvider).
 */
public final class Oauth1SigningInterceptor implements Interceptor {
    ...
    public Oauth1SigningInterceptor(String consumerKey, String consumerSecret, TokenProvider tokenProvider, Random random, Clock clock) {
    ...
    public Response intercept(Chain chain) throws IOException {
        if (tokenProvider.accessToken() != null && tokenProvider.accessTokenSecret() != null) {
    ...
    public Request signRequest(Request request) throws IOException {
        ...
        String signingKey =
                UrlEscapeUtils.escape(consumerSecret) + "&" + UrlEscapeUtils.escape(tokenProvider.accessTokenSecret());
    ...
    public static final class Builder {
        ...
        public Builder tokenProvider(TokenProvider tokenProvider) {
            if (tokenProvider == null) throw new NullPointerException("tokenProvider provider = null");
            this.tokenProvider = tokenProvider;
            return this;
        }
        ...
        public Oauth1SigningInterceptor build() {
            ...
            return new Oauth1SigningInterceptor(consumerKey, consumerSecret, tokenProvider, random, clock);
        }
    }
